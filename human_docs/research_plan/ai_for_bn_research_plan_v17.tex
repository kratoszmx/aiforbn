...
\IfFontExistsTF{Songti TC}
  {\newCJKfontfamily\zhTitleFont{Songti TC}}
  {\IfFontExistsTF{Noto Serif CJK TC}
    {\newCJKfontfamily\zhTitleFont{Noto Serif CJK TC}}
    {\newCJKfontfamily\zhTitleFont{PingFang TC}}}
\setlength{\parindent}{0pt}
\setlength{\parskip}{0pt}
\setlist[itemize]{leftmargin=*,itemsep=0pt,topsep=0pt}
\setlist[enumerate]{leftmargin=*,itemsep=0pt,topsep=0pt}
...
\begin{center}
    ...
    \vspace{10pt}
    {\small\underline{\textbf{Application Form for Shenzhen Zhongneng Tianyi Technology Co., Ltd. Grant}}}\\
\end{center}
...
\begin{itemize}[leftmargin=15pt]
    ...
    \vspace{-8pt}
    \item Chinese Project Title: {\zhTitleFont 人工智能驅動的氮化硼材料探索}
\end{itemize}

\vspace{-20pt}
\section{Abstract of the Project}
\vspace{-10pt}
This project aims to build an AI-powered BN material exploration framework for prioritizing BN-related candidates in ultraviolet/wide-band-gap and dielectric/2D-support applications. The immediate challenge is not a lack of possible BN variants, but the absence of a \textbf{reliable decision layer} for sparse BN labels, formula-level extrapolation, and uncertain structure follow-up.

Our framework will make this decision process concrete: it will define a bounded BN design space, combine public 2D materials data with BN-centered diagnostics, screen formula-only candidates, and generate prototype-first structure hypotheses. Candidate decisions will use \textbf{target-window relevance, stability proxies, uncertainty, domain support, novelty, and action labels}.
...
\vspace{-10pt}
The total funding requested is $850,000$ HKD, which is broken down as follows:
\vspace{-6pt}
\begin{center}
\small
\begin{tabular}{|>{\raggedright\arraybackslash}p{0.17\linewidth}|>{\raggedright\arraybackslash}p{0.57\linewidth}|>{\raggedright\arraybackslash}p{0.16\linewidth}|}
\hline
\textbf{Budget item} & \textbf{Detail breakdown and justification} & \textbf{Estimate cost} \\
\hline
Staffing & Recruiting research/student helper support for data cleaning, benchmark scripts, candidate-table verification, figure generation, documentation, and demo maintenance. & 430,000 HKD \\
\hline
Equipment & GPU/cloud hours for model training and ensemble inference; storage for downloaded structures, generated CIF/POSCAR files, benchmark logs, and checkpoints. & 220,000 HKD \\
\hline
General expenses & Cloud credits, software services, repository backup, stakeholder-facing demo hosting, and data-management costs. & 80,000 HKD \\
\hline
Conference & Registration and presentation materials for AI-for-science, materials informatics, or applied computing venues. & 40,000 HKD \\
\hline
Overseas Travel & PI-approved stakeholder visit, technical meeting, or overseas conference travel for candidate-review discussion. & 80,000 HKD \\
\hline
\multicolumn{2}{|r|}{\textbf{Total}} & \textbf{850,000 HKD} \\
\hline
\end{tabular}
\normalsize
\vspace{-12pt}
