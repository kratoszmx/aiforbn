# Research Plan Draft Archive

## Purpose

This archive preserves the proposal drafts and template materials that existed before the 2026-06-29 title/generalization revision requested after the PI feedback.

Do not delete or overwrite these files. In particular, `ai_for_bn_research_plan_v8.tex` and `ai_for_bn_research_plan_v8.pdf` are preserved here as the last pre-generalization draft.
