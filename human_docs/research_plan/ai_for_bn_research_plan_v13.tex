...
\begin{itemize}[leftmargin=15pt]
    ...
    \item Collaborator(s): Shenzhen Zhongneng Tianyi Technology Co., Ltd.
...
\]
The local codebase already implements a formula-level BN candidate-ranking prototype with grouped evaluation, BN-focused diagnostics, uncertainty and support penalties, and structure-follow-up artifacts. This proposal extends that prototype into a more general AI-powered BN material exploration framework.
...
Shenzhen Zhongneng Tianyi Technology Co., Ltd. will provide application-level feedback at two checkpoints: after formula-stage ranking and after structure-hypothesis packaging. The partner-facing package will contain predicted properties, uncertainty estimates, domain-distance flags, novelty labels, validation notes, and recommended action labels, not unverified discovery claims.
...
\begin{enumerate}
  ...
  \item \textbf{D5:} Technical report, figures, collaborator review package, lightweight demo interface, and manuscript-ready analysis.
\end{enumerate}
...
\textbf{金额（港元）}\\
\midrule
人员开支 & Student helper / research assistant support for data cleaning, benchmark scripts, candidate-table verification, figure generation, documentation, and demo maintenance. & \blank\\
设备 & GPU cloud hours for graph-model training and ensemble inference; storage for downloaded structures, generated CIF/POSCAR files, benchmark logs, and model checkpoints. & \blank\\
一般开支 & Cloud credits, repository backup, software services, collaborator-facing demo hosting, and data-management costs. & \blank\\
会议开支 & Registration and presentation materials for AI-for-science, materials informatics, or applied computing venues. & \blank\\
海外差旅 & Optional PI-approved collaborator visit, technical meeting, or conference travel for candidate-review discussion. & \blank\\
\midrule
 & \textbf{申请资助总额} & \blank\\
\bottomrule
\end{tabular}
