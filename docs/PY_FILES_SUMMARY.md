...
Nonempty structure-execution summary and variants frames must also carry their canonical role column before publication, preventing the public writer from committing builder frames under swapped CSV roles while retaining valid partial/empty outputs.
