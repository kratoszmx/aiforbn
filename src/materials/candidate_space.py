...
from materials.constants import (
    ...
    DEFAULT_PROPOSAL_SHORTLIST_LABEL,
    DEFAULT_PROPOSAL_SHORTLIST_METHOD,
    DEFAULT_PROPOSAL_SHORTLIST_NOTE,
    DEFAULT_ROBUSTNESS_METHOD,
    DEFAULT_ROBUSTNESS_NOTE,
    DEFAULT_STRUCTURE_GENERATION_SEED_CANDIDATE_SCOPE,
    DEFAULT_STRUCTURE_GENERATION_SEED_LABEL,
    DEFAULT_STRUCTURE_GENERATION_SEED_METHOD,
