...
- `validate_agent_layout(project_root_path='.', manifest=None)`
  - Validate required agent-facing files, command surfaces, module contracts, exact v18 source-file and ordered deliverable-chain alignment, validation profiles, dependency imports, and known layout warnings.
